defmodule EngHubWeb.ProjectLiveTest do
  ...
  describe "Index" do
    ...
    test "lists all projects", %{conn: conn, user: user, project: project} do
    ...
    test "saves new project", %{conn: conn, user: user} do
    ...
    test "updates project in listing", %{conn: conn, user: user, project: project} do
      {:ok, index_live, _html} = live(conn, ~p"/projects")
    ...
    test "deletes project in listing", %{conn: conn, user: user, project: project} do
      {:ok, index_live, _html} = live(conn, ~p"/projects")
  ...
  describe "Show" do
    ...
    test "displays project", %{conn: conn, user: user, project: project} do
    ...
    test "updates project and returns to show", %{conn: conn, user: user, project: project} do
